...
export interface SocialChannel {
  ...
  handle: string;
  href: string | null;
  icon: 'instagram' | 'linkedin' | 'facebook' | 'tiktok' | 'youtube';
}

export const CONTACT_EMAIL = 'inventech.sas@gmail.com';
export const CONTACT_WEBSITE = 'www.inventech.com.co';
...
export const SOCIAL_CHANNELS: SocialChannel[] = [
  ...
  { id: 'tiktok', name: 'TikTok', handle: '@inventech_app', href: 'https://tiktok.com/@inventech_app', icon: 'tiktok' },
